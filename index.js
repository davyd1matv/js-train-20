...
function Car(brand, model, year, mileage, fuelType, speed) {
  ...
  this.prototype.toString = () => {
    return `${this.brand} ${this.model} ${this.year} ${this.mileage} ${this.fuelType}`;
  };
  ...
  this.prototype.accelerate = (speed) => {
    this.speed += speed;
    console.log(
...
// let Car = new Car(brand, model, year, mileage, fuelType, speed);
...
function Truck(
  ...
  Vehicle.call(this.brand, this.model, this.year, this.mileage);
  ...
  this.prototype.specific = (towingCapacity) => {
    if (towingCapacity > 0) {
      console.log(
